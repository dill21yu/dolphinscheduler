...
CREATE TABLE t_ds_external_system (
    id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY COMMENT 'Primary key',
    name VARCHAR(255) NOT NULL COMMENT 'System name',
    type VARCHAR(50) COMMENT '[Temporarily unused] System type',
    connection_params CLOB NOT NULL COMMENT 'Connection parameters (JSON format)',
...
CREATE TABLE t_ds_relation_external_system_user (
    ...
    external_system_id INT NOT NULL COMMENT 'External system ID',
    perm INT DEFAULT 1 COMMENT 'Permission level',
    create_time TIMESTAMP DEFAULT NULL COMMENT 'Creation time',
    update_time TIMESTAMP DEFAULT NULL COMMENT 'Update time'
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
