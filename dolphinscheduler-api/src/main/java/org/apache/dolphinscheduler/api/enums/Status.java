...
public enum Status {
    ...
    CREATE_EXTERNAL_SYSTEM_ERROR(11042, "create external system error", "创建外部系统错误"),
    UPDATE_EXTERNAL_SYSTEM_ERROR(11043, "update external system error", "更新外部系统错误"),
    QUERY_EXTERNAL_SYSTEM_ERROR(11044, "query external system error", "查询外部系统错误"),
    DELETE_EXTERNAL_SYSTEM_ERROR(11045, "delete external system error", "删除外部系统错误"),
    TEST_EXTERNAL_SYSTEM_CONNECTION_ERROR(11046, "connect  external system failure", "建立外部系统连接失败"),
    EXTERNAL_SYSTEM_NOT_EXIST(11047, "external system not exist", "外部系统不存在"),
    EXTERNAL_SYSTEM_NAME_EXIST(11048, "external name exist", "外部系统名称已存在"),
    EXTERNAL_SYSTEM_CONNECT_FAILED(11049, "external connect failed", "外部系统连接失败"),
    UNAUTHORIZED_EXTERNAL_SYSTEM(10050, "unauthorized datasource", "未经授权的外部系统"),
    AUTHORIZED_EXTERNAL_SYSTEM(10051, "authorized data source", "授权外部系统失败"),
    EXTERNAL_SYSTEM_NAME_EMPTY(11052, "external system name is empty", "外部系统名称为空"),
    EXTERNAL_SYSTEM_SERVICE_ADDRESS_EMPTY(11053, "external system service address is empty", "外部系统服务地址为空"),
    EXTERNAL_SYSTEM_AUTH_CONFIG_EMPTY(11054, "external system auth config is empty", "外部系统认证配置为空"),
    EXTERNAL_SYSTEM_AUTH_CONFIG_TYPE_EMPTY(11055, "external system auth config type is empty", "外部系统认证类型为空"),
    EXTERNAL_SYSTEM_BASIC_USERNAME_EMPTY(11056, "external system basic username is empty", "外部系统基础认证用户名为空"),
    EXTERNAL_SYSTEM_BASIC_PASSWORD_EMPTY(11057, "external system basic password is empty", "外部系统基础认证密码为空"),
    EXTERNAL_SYSTEM_JWT_TOKEN_EMPTY(11058, "external system jwt token is empty", "外部系统JWT令牌为空"),
    EXTERNAL_SYSTEM_OAUTH2_TOKEN_URL_EMPTY(11059, "external system oauth2 token url is empty", "外部系统OAuth2令牌URL为空"),
    EXTERNAL_SYSTEM_OAUTH2_CLIENT_ID_EMPTY(11060, "external system oauth2 client id is empty", "外部系统OAuth2客户端ID为空"),
    EXTERNAL_SYSTEM_OAUTH2_CLIENT_SECRET_EMPTY(11061, "external system oauth2 client secret is empty",
            "外部系统OAuth2客户端密钥为空"),
    EXTERNAL_SYSTEM_OAUTH2_GRANT_TYPE_EMPTY(11062, "external system oauth2 grant type is empty", "外部系统OAuth2授权类型为空"),
    EXTERNAL_SYSTEM_OAUTH2_USERNAME_EMPTY(11063, "external system oauth2 username is empty", "外部系统OAuth2用户名为空"),
    EXTERNAL_SYSTEM_OAUTH2_PASSWORD_EMPTY(11064, "external system oauth2 password is empty", "外部系统OAuth2密码为空"),
    EXTERNAL_SYSTEM_AUTH_TYPE_UNSUPPORTED(11065, "external system auth type is unsupported", "外部系统认证类型不支持"),
    EXTERNAL_SYSTEM_SELECT_INTERFACE_EMPTY(11066, "external system select interface is empty", "外部系统查询接口配置为空"),
    EXTERNAL_SYSTEM_SUBMIT_INTERFACE_EMPTY(11067, "external system submit interface is empty", "外部系统提交接口配置为空"),
    EXTERNAL_SYSTEM_POLL_STATUS_INTERFACE_EMPTY(11068, "external system poll status interface is empty",
            "外部系统轮询状态接口配置为空"),
    EXTERNAL_SYSTEM_STOP_INTERFACE_EMPTY(11069, "external system stop interface is empty", "外部系统停止接口配置为空"),
    EXTERNAL_SYSTEM_INTERFACE_URL_EMPTY(11070, "external system interface url is empty", "外部系统接口URL为空"),
    EXTERNAL_SYSTEM_INTERFACE_METHOD_EMPTY(11071, "external system interface method is empty", "外部系统接口方法为空"),
    ...
    GRANT_EXTERNALSYSTEM_ERROR(100971, "grant external system error", "授权外部系统错误"),
